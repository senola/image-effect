module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: { // 文件监听
            ...
            scripts: {
                files: ['image-effect/javascript/*.js'],
                //tasks: ['concat', 'uglify'],
                options: {
                    spawn: false,
                }
            ...
            html: {
                files: ['image-effect/*.html'],
            },
            css: {
                files: ['image-effect/sass/*.scss'],
                tasks: ['sass'],
                options: {
                    spawn: false,
                }
        ...
        sass: {  // sass预处理器
            dist: {  
                  ...
                  files: { 
                    'image-effect/stylesheet/image-effect.css': 'main.scss', // '目标文件': '源文件'
                  }
            }
        }
    });
